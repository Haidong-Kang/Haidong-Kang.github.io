...
- <span style="background-color: #FFE4CC; color: #D84315; padding: 2px 6px; border-radius: 4px; font-weight: bold;">CVPR 2026</span> Hanling Wang, Qing Li*, Li Chen, **Haidong Kang**, Fei Ma, Yong Jiang. HoloTrace: LLM-based Bidirectional Causal Knowledge Graph for Edge-Cloud Video Anomaly Detection.
...
- <span style="background-color: #FFE4CC; color: #D84315; padding: 2px 6px; border-radius: 4px; font-weight: bold;">IEEE TC</span> Lianbo Ma, **Haidong Kang**, Guo Yu, Qing Li, Qiang He, Single-Domain Generalized Predictor for Neural Architecture Search System.
- <span style="background-color: #FFE4CC; color: #D84315; padding: 2px 6px; border-radius: 4px; font-weight: bold;">IEEE TMC</span> HL Wang, Q Li*, **H Kang**, etc. ParaLoupe: Real-time Video Analytics on Edge Cluster via Mini Model Parallelization.
